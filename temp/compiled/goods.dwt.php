...
function qtyAction(quantity){
	...
	var goods_price="<?php echo $this->_var['goods']['shop_price_formated']; ?>";
	goods_price=goods_price.replace('$','');
	var upLimit="<?php echo $this->_var['goods']['goods_number']; ?>";
  ...
  <div class="showcase" >
   ...
   <div id="goodsInfo" >
     ...
     <a href="javascript:;" onclick="window.open('gallery.php?id=<?php echo $this->_var['goods']['goods_id']; ?>'); return false;">
      <img src="<?php echo $this->_var['goods']['goods_img']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"  width="350" height="320"/>
     </a>
         <?php else: ?>
     ...
     <div class="clearfix">
      <p class="f_l" style=" height:40px; line-height:40px; font-size:16px; padding-left:10px"><?php echo $this->_var['goods']['goods_style_name']; ?></p>
      <p class="f_r">
...
?>
      ...
      <li class="padd">
       ...
       <table width="80%" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffd3e0" style="display:block">
        <tr>
          <td align="center" width="30%"  bgcolor="#FFFFFF"><strong><?php echo $this->_var['lang']['number_to']; ?></strong></td>
          <td align="center" width="220" bgcolor="#FFFFFF"><strong><?php echo $this->_var['lang']['preferences_price']; ?></strong></td>
        </tr>
...
?>
    ...
    <!--  <?php echo $this->smarty_insert_scripts(array('files'=>'lefttime.js')); ?>
      ...
      <!--<li>
       <dd  style="color:#F00">
       <strong><?php echo $this->_var['lang']['amount']; ?>：</strong><font id="ECS_GOODS_AMOUNT"></font>
       </dd>
       <!--  <dd class="ddR">
     ...
     <!-- <li class="clearfix">
       ...
       <dd class="ddR">
        <?php if ($this->_var['cfg']['use_integral']): ?> 购买此商品可使用积分-->
...
?>
      ...
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
       ...
       <div class="cart">
        <div class="price1">USD <font id="ECS_GOODS_AMOUNT" color="#FF0000"><?php echo $this->_var['goods']['shop_price']; ?></font></div>
 		 <div class="qty">
         ...
         <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" title="add to cart"  class="add"></a> 
        <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)" title="add to favorites"  class="favorites">Add to Favorites</a>
...
<div style="width:1000px; margin:0 auto;" >
     ...
     <div class="box_1">
      <h3>
        ...
        <h4><?php echo $this->_var['lang']['goods_brief']; ?></h4>
        <h4 class="h2bg"><?php echo $this->_var['lang']['goods_attr']; ?></h4>
        <?php if ($this->_var['package_goods_list']): ?>
        <h4 class="h2bg" style="color:red;"><?php echo $this->_var['lang']['remark_package']; ?></h4>
        <?php endif; ?>
        </div>
      </h3>
...
?>
        <strong><?php echo $this->_var['package_goods']['act_name']; ?></strong><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffeaf6">
        <tr>
        <td bgcolor="#FFFFFF">
