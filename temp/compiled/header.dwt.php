...
<?php echo $this->smarty_insert_scripts(array('files'=>'common.js,utils.js,index.js,jquery.min.js,slide.js')); ?>
</head>
<body>
<div class="top">
...
<div id="menu">
<ul id="nav">
	<li class="mainlevel"><a href="http://<?php echo $this->_var['home_url']; ?>">Home</a></li>
