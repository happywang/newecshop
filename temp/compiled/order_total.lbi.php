...
<table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
  ...
  <tr>
    <td align="right" bgcolor="#ffffff">
      <?php echo $this->_var['lang']['goods_all_price']; ?>: <font class="f4_b"><?php echo $this->_var['total']['formated_goods_price']; ?></font>
      ...
      <?php endif; ?>   
      <?php if ($this->_var['total']['regFee'] > 0): ?>
      + registration fee: <font class="f4_b"><?php echo $this->_var['total']['regFee']; ?></font>
      <?php endif; ?>
   </td>
  </tr>
