...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $source_price = isset($_POST['source_price']) ? ($_POST['source_price']) : '0';
    
    $goods_volume = isset($_POST['goods_volume']) ? ($_POST['goods_volume']) : '0';
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id,source_price,goods_volume,goods_size,goods_color,goods_source)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id','$source_price','$goods_volume','$goods_size','$goods_color','$goods_source')";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral,source_price,goods_volume,goods_size,goods_color,goods_source)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral','$source_price','$goods_volume','$goods_size','$goods_color','$goods_source')";
        }
    }
    else
    {
...
//-- 生成货号
/*------------------------------------------------------ */
elseif ($_REQUEST['act'] == 'huoy')
{
	$goodsSource = isset($_REQUEST['goods_source']) ? trim($_REQUEST['goods_source']) : null;
...
//-- 设置商品的价格
/*------------------------------------------------------ */
elseif ($_REQUEST['act'] == 'set_source_price')
{
	$goodsSource = isset($_REQUEST['source_price']) ? $_REQUEST['source_price'] : null;
	...
	$arr = array('shop_price'=>$shop_price,'market_price'=>$market_price,'reg_price'=>$reg_price,'vip_price'=>$vip_price
