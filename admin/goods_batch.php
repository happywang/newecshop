...
elseif ($_REQUEST['act'] == 'upload')
{
    ...
    /**********************add by wanghl*********************************/
    $sql = "SELECT `interest_rate` FROM " . $ecs->table('category') . " WHERE `cat_id` = '{$_POST['cat']}'";
    ...
    // 显示的字段列表
    $smarty->assign('field_show', array('goods_volume' => true,'goods_size' => true,'goods_color' => true,'goods_name' => true, 'goods_sn' => true, 'brand_name' => true, 'source_price' => true, 'market_price' => true, 'shop_price' => true));
